...
//		Databaza databaza = new Databaza("jdbc:mysql://sql11.freesqldatabase.com:3306/sql11704147", "sql11704147",
//				"u2jLgFHwtn");
				...
				case 1:
					...
					switch (scanner.nextInt()) {
						...
						case 2:
							...
							scanner.nextLine();
							Ucebnica ucebnica = new Ucebnica(nazovUcebnice, autorUcebnice, rokUcebnice,
									vekovaKategoria);
